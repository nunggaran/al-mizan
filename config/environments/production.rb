Rails.application.configure do
  ...
  # config.assets.paths << Rails.root.join("v2")
  # config.action_controller.default_url_options = { host: "https://indoexchanger.co.id/v2/" }
  # Rails.application.routes.default_url_options = { host: "https://indoexchanger.co.id/v2/" }
  # config.assets.prefix = "/v2"
